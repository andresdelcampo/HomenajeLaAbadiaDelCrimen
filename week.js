...
(() => {
  ...
  const advice = t([
    'Si sales, espera a que el Abad se retire y vuelve antes de prima. Lleva a Adso y la lámpara al laberinto: el aceite solo se consume en las salas oscuras. Adso avisa al cabo de aproximadamente un minuto y medio y la lámpara se apaga tras unos tres minutos de uso.',
    ...
    'If you leave, wait for the Abbot to retire and return before prime. Take Adso and the lamp into the labyrinth: oil is consumed only in its dark rooms. Adso warns you after about a minute and a half, and the lamp goes out after roughly three minutes of use.',
  ...
  const events = {
    '1-4': { text: t('El Abad recibe a los visitantes en la entrada, explica el crimen durante el paseo y los lleva a su celda.', 'The Abbot receives the visitors at the entrance, explains the crime during the walk and leads them to their cell.'), action: t('Sigue al Abad sin separarte: la partida comienza al atardecer, en nona, con un paseo de bienvenida que tiene varias paradas.', 'Stay close to the Abbot: the game begins at dusk, at none, with a welcome walk that has several stops.'), q: [[2,1],[2,2],[2,3],[2,7]] },
    ...
    '2-4': { text: t('Berengario vigila el manuscrito de Venancio. Si Guillermo lo toma, la advertencia puede convertirse en una denuncia al Abad.', 'Berengar watches Venantius’s manuscript. If William takes it, the warning can become a report to the Abbot.'), action: t('Planifica cómo conservar el pergamino. La amenaza se activa si Guillermo lo lleva, pasa cierto tiempo y cambia de pantalla; puede ocurrir fuera de nona.', 'Plan how to keep the scroll. The threat is triggered if William carries it, some time passes and he changes screens; it can happen outside none.'), q: [[4,4]] },
    ...
    '5-0': { text: t('Durante la noche aparecen la llave I en el altar y las gafas en la habitación iluminada del laberinto. La llave desaparece en prima si Guillermo no la lleva.', 'During the night, key I appears on the altar and the spectacles in the illuminated maze room. The key disappears at prime unless William carries it.'), action: t('Recoge la llave del altar durante esta noche. Permite acceder a la celda del Abad; procura que no te sorprenda al volver.', 'Collect the altar key during this night. It opens the Abbot’s cell; make sure he does not catch you on your return.') },
    ...
    '6-0': { text: t('La llave II aparece en la mesa de Malaquías. Las gafas, colocadas en la habitación iluminada desde la noche V, siguen allí si aún no las has recogido. La lógica también activa ya a Jorge detrás del espejo, pero la guía de Micromanía reserva ese encuentro para la noche VII.', 'Key II appears on Malachi’s desk. The spectacles, placed in the illuminated room on night V, remain there if you have not collected them. The game logic also activates Jorge behind the mirror now, but Micromanía’s walkthrough reserves that encounter for night VII.'), action: t('Vuelve a la biblioteca con Adso y la lámpara: recoge la llave II en el scriptorium y recupera las gafas en la habitación iluminada. Aprovecha esta noche para practicar el recorrido del laberinto y regresa a la celda; los guantes vienen después. Si abres ahora el espejo y recoges el libro de Jorge, sus páginas envenenadas matarán a Guillermo.', 'Return to the library with Adso and the lamp: collect key II in the scriptorium and recover the spectacles from the illuminated room. Use this night to practise the labyrinth route and return to your cell; the gloves come later. If you open the mirror now and take Jorge’s book, its poisoned pages will kill William.') },
    '6-2': { text: t('El Abad anuncia que Guillermo deberá partir al día siguiente.', 'The Abbot announces that William must leave the next day.'), action: t('Usa la llave II para entrar en la celda de Severino y recoger los guantes. Aún queda recuperar el pergamino antes de volver al laberinto para el desenlace.', 'Use key II to enter Severinus’s cell and collect the gloves. You still need to recover the scroll before returning to the labyrinth for the ending.'), q: [[2,30]] },
    ...
    '7-0': { text: t('Jorge espera detrás del espejo desde la noche VI. Para llegar al desenlace hay que encontrarlo, recoger el libro y superar la trampa de sus páginas envenenadas.', 'Jorge has been waiting behind the mirror since night VI. To reach the ending, you must find him, take the book and survive the trap of its poisoned pages.'), action: t('Entra con los guantes, las gafas y el pergamino, y con Adso llevando la lámpara. Tras descubrir los guantes, Jorge huye con el libro hacia la habitación iluminada; síguelo.', 'Enter with the gloves, spectacles and scroll, and with Adso carrying the lamp. On discovering the gloves, Jorge flees with the book towards the illuminated room; follow him.'), q: [[6,33],[1,35]] },
  ...
  const objectAdvice = {
    ...
    '5-0': t('Guillermo debe conservar la llave I hasta prima: recogerla y dejarla no evita su desaparición. Las gafas reaparecen esta noche en la habitación iluminada del laberinto y ya no vuelven a perderse al amanecer.', 'William must keep key I until prime: picking it up and dropping it does not prevent its disappearance. The spectacles reappear tonight in the illuminated room of the labyrinth and will not be lost again at dawn.'),
    ...
    '6-0': t('Objetivo de esta salida: Guillermo regresa con la llave II y las gafas; Adso conserva la llave III y lleva la lámpara. No necesitas abrir aún el espejo.', 'Goal for this outing: William returns with key II and the spectacles; Adso keeps key III and carries the lamp. You do not need to open the mirror yet.')
  };
