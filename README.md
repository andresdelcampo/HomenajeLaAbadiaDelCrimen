...
- **Investigar todos sus secretos.** Ocho personajes con agendas propias, los siete días con protección frente a spoilers, objetos y llaves, Obsequium, mapas, laberinto, cronología, adaptaciones, publicidad, prensa española y británica, reconstrucciones técnicas y el legado de una obra irrepetible.
...
| [El juego](es/juego.html) | Pergaminos interactivos, personajes, objetos, siete jornadas, mapas y el atlas completo de estancias. |
...
- **Investigate all its secrets.** Eight characters with schedules of their own, all seven days with spoiler protection, objects and keys, Obsequium, maps, the labyrinth, chronology, adaptations, advertising, Spanish and British press, technical reconstructions, and the legacy of a singular game.
...
| [The game](en/game.html) | Interactive manuscripts, characters, objects, seven days, maps, and the complete room atlas. |
